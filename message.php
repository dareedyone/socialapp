        ...
        <div class="row">
            <div class="col-sm-4 border-right webchat-panel">
                ...
                <div class="d-flex my-3 body-home justify-content-between new-message py-2 px-2 rounded-pill">
                    <div class="d-flex">
                        <img class="status-pic mr-2 rounded-circle" src="assets/images/user-default.png" alt="profile picture">
                ...
                <div class="friend-suggest px-2 mb-3">
                    <div class="d-flex">
                        <img class="status-pic mr-2 rounded-circle" src="assets/images/user-6.jpg" alt="profile picture">
                        <div>
                ...
                <div class="friend-suggest px-2 mb-3">
                    <div class="d-flex">
                        <img class="status-pic mr-2 rounded-circle" src="assets/images/user-3.jpg" alt="profile picture">
                        <div>
                ...
                <div class="friend-suggest px-2 mb-3">
                    <div class="d-flex">
                        <img class="status-pic mr-2 rounded-circle" src="assets/images/user-5.jpg" alt="profile picture">
                        <div>
            ...
            <div class="col-sm-8 webchat-panel-desktop webchat-panel position-relative">
                ...
                <div class="d-flex flex-column align-items-end chat-space">
